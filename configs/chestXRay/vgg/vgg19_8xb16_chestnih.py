...
model = dict(
    ...
    backbone=dict(type='VGG', depth=19, norm_cfg=dict(type='BN'), num_classes=14),
    neck=None,
    head=dict(
...
load_from = 'https://download.openmmlab.com/mmclassification/v0/vgg/vgg19_bn_batch256_imagenet_20210208-da620c4f.pth'  # vgg19 bn
