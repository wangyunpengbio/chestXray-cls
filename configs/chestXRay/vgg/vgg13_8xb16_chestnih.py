...
model = dict(
    ...
    backbone=dict(type='VGG', depth=13, norm_cfg=dict(type='BN'), num_classes=14),
    neck=None,
    head=dict(
...
load_from = 'https://download.openmmlab.com/mmclassification/v0/vgg/vgg13_bn_batch256_imagenet_20210207-1a8b7864.pth'  # vgg13 bn
