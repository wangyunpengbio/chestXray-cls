...
model = dict(
    ...
    backbone=dict(type='VGG', depth=16, norm_cfg=dict(type='BN'), num_classes=14),
    neck=None,
    head=dict(
...
load_from = 'https://download.openmmlab.com/mmclassification/v0/vgg/vgg16_bn_batch256_imagenet_20210208-7e55cd29.pth'  # vgg16 bn
